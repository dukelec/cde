...
let trans_hk = {
    ...
    'Data is too large for URL encoding, continue?': '數據對於 URL 編碼過大，是否繼續？',
    'Copy to clipboard successed': '成功複製到剪切板',
    'Copy to clipboard failed': '複製到剪切板失敗',
...
let trans_cn = {
    ...
    'Sharing is not supported': '不支持分享',
    'Data is too large for URL encoding, continue?': '数据对于 URL 编码过大，是否继续？',
    'Copy to clipboard successed': '成功复制到剪切板',
    'Copy to clipboard failed': '复制到剪切板失败',
    'File sharing is not supported': '不支持的文件分享',
